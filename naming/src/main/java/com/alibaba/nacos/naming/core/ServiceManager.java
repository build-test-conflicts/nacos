 ...
 */
  ...
  @Autowired private ServerListManager serverListManager;
  @Autowired private PushService pushService;
  private Object putServiceLock=new Object();
  ...
  @Override public boolean interests(  String key){
    return KeyBuilder.matchServiceMetaKey(key) && !KeyBuilder.matchSwitchKey(key);
  }
  @Override public boolean matchUnlistenKey(  String key){
    return KeyBuilder.matchServiceMetaKey(key) && !KeyBuilder.matchSwitchKey(key);
  }
  @Override public void onChange(  String key,  Service service) throws Exception {
    try {
      if (service == null) {
  ...
  @Override public void onDelete(  String key) throws Exception {
...
private class ServiceUpdater implements Runnable {
  ...
  public void updatedHealthStatus(  String namespaceId,  String serviceName,  String serverIP){
    ...
    Loggers.EVT_LOG.info("[IP-UPDATED] namespace: {}, service: {}, ips: {}",service.getNamespaceId(),service.getName(),stringBuilder.toString());
  }
